...
class RecommendationCard extends StatelessWidget {
  final Item item; // Change type to Item
  const RecommendationCard({Key? key, required this.item, this.onTap})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    final shortenedLocation =
        _shortenLocation(item.address ?? "Default Address");
                      ...
                      child: FittedBox(
                        child: CachedNetworkImage(
                          ...
                          progressIndicatorBuilder: (context, url, download) {
                            //print('https://maps.googleapis.com/maps/api/place/photo?maxwidth=80&maxheight=80&photoreference=${item.item!.photo_reference}&key=$_apiKey');
